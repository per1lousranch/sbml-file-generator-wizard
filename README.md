...
Uses GPT 5.5 to generate an SBML file from an image provided. Users can upload their own image and save the results to disk, as well as run validation against SBML specification.
